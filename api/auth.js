...
function isAllowedOrigin(origin) {
  ...
  return /^https:\/\/habitrii-[a-z0-9]+-haiden-s-projects\.vercel\.app$/.test(origin);
}
          ...
          outer: for (const sub of subscriptions.data) {
            ...
            if (sub.metadata?.tier === "transformation") { resolvedTier = "transformation"; break outer; }
                  ...
                  for (const item of sub.items.data) {
                            ...
                            if (priceId && transformationIds.includes(priceId)) { resolvedTier
                                                                                 = "transformation"; break outer; }
